...
function DBLsize() {
	...
	$url = "http://211.169.249.31/api/foblgate/division/dblsize.php";
...
function getProductList($type) {
    ...
    $sql = "select * from g5_product where prd_type = '{$type}' and prd_use = 'Y'";
