...
$.i18n.init({
    ...
    resStore: {
        "en-US": {
            "INDEX": {
                "1":"ALLOT aims to seek maximum compensation while protecting the user's investment as much as possible with a system that organizes and recommends portfolios with products optimized for the user's needs.",         
                "2":"ALLOT is preparing more diverse content.",         
                "3":"PROBIT Exchange Listed Guidance",                
                "3_1":"COINBIG  Exchange Listed Guidance",                
                "4":"ALLOT will be listed on the PROBIT Korea Exchange on December 17th.",
                "4_1":"This is to inform you that ALLOT Coin has been listed on CoinBig.",
                "4_2":"2021 . 06 . 03",
                "4-1":"We originally tried to open the steaking service on April 1, but we inform you that the schedule was inevitably postponed due to the blocked deposit and withdrawal due to the wallet inspection in the exchange.",                
                "4-2":"ALLOT incinerated 90% of the issue volume to increase the value.",                
                "4-3":"10 Billion ALT > 1 Billion ALT",                
                ...
                "26":"The ALLOT platform helps users recommend intelligent portfolios and builds a true intelligent investment advisory and management platform in the DePi area.",
                "27":"The ALLOT platform provides users with a choice of a period of optimal interest rate according to their convenience. The quantity that can be attracted to the ALLOT platform can be designated by the user, and ALLOT can be purchased from the exchange and ALLOT can be withdrawn at the end of the bidding period. The interest rate is calculated as an annual interest rate and the daily interest rate is paid in ALLOT for the period of deposit. In line with the purchase of ALLOT on the exchange and consumption on the ALLOT platform, the price of ALLOT will rise rather than fall and operate as a system that can bring high profits to consumers.",
                "28":"USD PLETFORM will pay the return on a daily basis if ALLOT converted into USD is attracted to the user's investment principal for a certain period of time, and will pay ALLOT on the USD basis at the end of the deposit period, regardless of the price of ALLOT, it will pay everything on USD basis.",
                "29":"You can find out more about ALLOT DeFi SYSTEM in the white paper.",
                "30":"Decentrality",
                ...
                "45":"The ALLOT team will use the funds raised for the platform development and maintenance, production, development and design team's labor costs.",     
                "46":"The success or failure of the platform is not only accomplished by successful platform development but also by the best platform operation. The ALLOT team will be used for the operation team and the service team for smooth and pleasant operation. We will do our best to expedite the platform's interest payments.",     
                "47":"ALLOT will be used for public relations, marketing and partnership activities with partner foundations and companies to promote global awareness.",     
                "48":"To run the ALLOT Foundation ethically, it requires compliance with laws, duties of tax collection, and a clear disclosure of the company's management situation. Therefore, ALLOT will use legal, tax and accounting services as administrative expenses.",     
                "49":"What is DeFi?",     
            ...
            "burm":{
                "1":"When nodes verify transactions on a blockchain, a new cryptocurrency is 'issued' as a reward.",
                "2":"On the other hand, there is the opposite process. It's the process of 'digestion' of cryptocurrency.",
                "3":"Let's look at how incineration is done on the blockchain and under what circumstances incineration occurs.",
                "4":"What is TOKEN BURN?",
                "5":"TOKEN BURN literally means permanently removing coins from circulation to reduce the total supply of coins.",
                "6":"The term 'burn' was used not only in the cryptocurrency market but also in the stock market.",
                "7":"It's literally a term that means that you're going to get rid of stocks and tokens.",
                "8":"Incineration in the token market is similar to incineration in the stock market.",
                "9":"After purchasing our token, we will send the cryptocurrency to a specific address (called Eater Address) where no one knows the private key.",
                "10":"Because no one knows the private key, the token at this address will not be available to anyone, so it can serve as an incinerator.",
                "11":"Why TOKEN BURN?",
                "12":"First.",
                "13":"The method of incinerating cryptocurrency by sending coin/token to an unavailable address is used in various cryptocurrencies. By intentionally incinerating money to reduce supply, it indirectly rewards cryptocurrency owners. Direct dividends to cryptocurrency owners are considered securities in many countries, including the United States, and complex procedures are required or prohibited. Therefore, cryptocurrency incineration is used as a way to compensate investors.",
                "14":"When a token is incinerated, the total supply of the token will eventually decrease and the value of the token will increase.",
                "15":"Therefore, token holders can benefit indirectly.",
                "16":"Second.",
                "17":"Another scenario where cryptocurrency is incinerated is when coins and tokens created for sale are all incinerated if they are incinerated. This is an example used to maintain fairness. If you do not incinerate tokens that have not been sold during the ICO process, the issuing company may make unfair profits by selling the remaining tokens to the market after listing them. In order to prevent this situation and maintain fairness, many projects even notify before ICO of plans to incinerate unsold coins and tokens.",
                "18":"Investors may suspect that the company could gain unfair advantage by selling the remaining tokens to the market if they are not incinerated during the ICO process.",
                "19":"To prevent this and ensure fairness, the company incinerates tokens, which will increase its credibility.",
                "20":"Principles and processes of TOKEN BURN",
                "21":"Then, what process is the TOKEN BURN going through?",
                "22":"As mentioned above, the specific address that no one knows the private key is called Eater Address.",
                "23":"This address generates a valid address randomly rather than from a specific private key.",
                "24":"Since this public address Eater Address alone will never find out the private key, the cryptocurrency deposited to the address will not be available to anyone.",
                "25":"Example of Eater Address in Actual Use",
                "26":"bitcoin : 1BitcoinEaterAddressDontSendf59kuE",
                "27":"Ethereum: 0x00000000000000000000000000000000dEaD",
                "28":"(You will also use the Ethereum Eater Address above when incinerating WITH Token (WIKEN) based onERC-20.)",
                "29":"When is the TOKEN BURN schedule for ALLOT coins?",
                "30":"The TOKEN BURN schedule of ALLOT coins is scheduled for 2021.03.31.",
                "31":"How much is the incineration of ALLOT coins?",
                "32":"ALLOT Foundation decided to incinerate 90% of ALT Coin issue volume. 10 billion ALT > 1 billion ALT",
                "33":"What about the TOKEN BURN EATER ADDRESS of ALLOT coins?",
                "34":"ALLOT Coin is an Ethereum token, and the incineration address is 0x0000000000000000000000000000DEaD.",
            }
        },
        "ko-KR": {
            "INDEX": {
                "1":"ALLOT는 사용자의 니즈에 최적화된 상품으로 포트폴리오를 구성, 추천하는 시스템으로 사용자의 투자금을 최대한 보호하면서 최대한의 보상을 추구하는것을 목표로 합니다.",         
                "2":"ALLOT이 더 다양한 내용을 준비하고 있습니다.",         
                "3":"PROBIT 거래소 상장 안내",                 
                "3_1":"COINBIG  거래소 상장 안내",                 
                "4":"12/17일 ALLOT이 PROBIT korea 거래소에 상장합니다.",
                "4_1":"ALLOT코인이 코인빅에 상장하게 되었음을 알려드립니다.",
                "4_2":"2021 . 06 . 03",
                "4-1":"당초 4월1일 스테이킹 서비스를 오픈하려 했으나, 거래소 내 지갑점검으로 입출금이 막혀 일정이 부득이하게 연기되었음을 알려드립니다.",              
                "4-2":"ALLOT이 가치 상승을 위하여 발행량의 90%를 소각 하였습니다.",              
                "4-3":"100억개 > 10억개",              
                ...
                "24":"ALLOT은 기존 디파이 시스템을 업그레이드 하기로 하고 첫번째 플랫폼으로 전통적인 은행서비스와 유사한 이자 예금 및 이익 창출이라는 기능이 있다. 이 서비스를 통하여 사용자는 암호화폐 자산을 상대적으로 안전하게 입금하고 수익을 얻을수 있으며 세계 누구라도 이용할수 있는 효율성 높은 디파이 금융상품이다.",
                ...
                "26":"ALLOT 플랫폼은 사용자에게 지능적인 포트폴리오를 추천할수 있도록 도와주며 디파이영역에서 진정한 지능형 투자자문 및 관리 플랫폼을 구축한다.",
                "27":"ALLOT 플랫폼은 사용자의 편의에 맞추어 최적의 이율이 나오는 기간을 설정하여 선택할수 있도록 제공을 한다. ALLOT 플랫폼에 유치할수 있는 수량은 사용자가 지정할수 있으며 거래소에서 ALLOT을 구매해 ALLOT 플랫폼에 일정기간 유치시 일별로 높은 수익률을 제공해 드리며 유치기간 종료시 ALLOT을 출금 할수 있다. 이율은 연이율로 계산이 되며 예치하는 기간 만큼 일별 이율이 ALLOT로 지급이 된다. 거래소에서 ALLOT의 구매와 ALLOT 플랫폼에서의 소비가 맞물려 ALLOT의 가격은 하락 보다는 상승에 편승하게 될것 이며 소비자 에게는 높은 이익을 안겨줄수 있는 시스템으로 운영이 될 예정이다.",
                "28":"USD PLETFORM은 사용자 투자원금에 초첨을 맞추어 USD로 환산된 ALLOT를 일정 기간 유치하시면 수익률이 일별 계산되어 지급 되고 예치기간 종료시 예치하신 USD기준으로 ALLOT을 지급하여 드리는 방식으로 ALLOT의 가격과 상관없이 예치하신 USD 기준으로 모든것을 지급하여 준다.",
                "29":"ALLOT DeFi SYSTEM에 대한 다양한 내용을 백서에서 확인하실 수 있습니다.",
                "30":"탈중앙성",
                ...
                "45":"ALLOT팀은 모집한 자금의 플랫폼 개발 및 유지보수, 제작, 개발팀과 디자인팀의 인건비로 사용 예정이다.",     
                "46":"플랫폼의 성패는 성공적인 플랫폼 개발뿐만이 아닌 최상의 플랫폼 운영으로 완성이 된다. ALLOT팀은 원활하고 쾌적한 운영을 위하여 운영팀과 서비스팀을 위해 사용할 예정이다. 플랫폼의 이율 지급이 신속히 처리되도록 최선을 다할 것이다.",     
                "47":"ALLOT을 전세계적으로 알리기 위한 홍보, 마케팅 그리고 파트너 재단 및 회사와의 제휴 활동을 위하여 사용할 예정이다.",     
                "48":" ALLOT 재단을 윤리적으로 운영하기 위해서는 법률의 준수, 잡세의 의무, 회사 경영상황의 토명한 공개를 필요로 한다. 이에 ALLOT은 법무, 세무, 회계등의 업무를 행정비용으로 책정하여 사용할 예정이다.",     
                "49":"DeFi 란 무엇입니까?",     
            ...
            "burm":{
                "1":"블록체인 상에서 노드들이 트랜잭션을 검증하면 이에 대한 보상으로 새로운 암호화폐가 “발행”됩니다.",
                "2":"반면에 이와는 반대의 과정도 존재합니다. 바로 암호화폐 “소각” 과정입니다.",
                "3":"블록체인 상에서 소각은 어떤 방법으로 이루어지는지 그리고 어떤 상황에서 소각이 일어나는지 알아보겠습니다.",
                "4":"토큰 소각이란 무엇인가?",
                "5":"토큰 소각이란 말 그대로, 유통량에서 코인을 영구적으로 제거하여 전체 코인 공급량을 줄이는 것을 의미합니다.",
                "6":"소각(Burn)이라는 용어는 암호화폐시장뿐만 아니라 주식시장에서도 많이 사용되었던 용어인데요.",
                "7":"말 그대로 주식이나 토큰을 없애버린다는 뜻을 가진 용어입니다.",
                "8":"토큰 시장에서의 소각도 주식시장에서의 소각과 비슷합니다.",
                "9":"자사 토큰을 매입한 후 아무도 개인키를 모르는 특정 주소(Eater Address라고 합니다.)에 암호화폐를 전송하게 됩니다.",
                "10":"아무도 개인키를 모르기 때문에 이 주소에 있는 토큰은 그 누구도 사용하지 못하게 되어 소각의 역할을 할 수 있게 되는 셈이죠.",
                "11":"왜 토큰을 소각하는 것인가?",
                "12":"첫번째.",
                "13":"코인/토큰을 사용할 수 없는 주소로 보내 암호화폐를 소각하는 방법은 다양한 암호화폐에서 사용되고 있습니다. 의도적으로 화폐를 소각하여 공급량을 줄이므로써 간접적으로 암호화폐 소유자에게 보상을 주게 됩니다. 암호화폐 소유자들에게 직접적으로 배당을 주는 방식은 미국을 포함한 많은 국가에서 증권성으로 판단되어 복잡한 절차가 필요하거나 금지되어 있습니다. 따라서 암호화폐 소각은 투자자들에게 보상하는 방법중 하나로 쓰이고 있습니다.",
                "14":"토큰이 소각되면 결국 전체 토큰의 공급량이 줄어들고 이에따라 토큰의 가치가 높아지게 됩니다.",
                "15":"따라서 토큰 홀더들은 간접적인 이익을 볼 수가 있습니다.",
                "16":"두번째.",
                "17":"암호화폐를 소각하는 또 다른 시나리오는 판매를 위해서 생성한 코인, 토큰이 모두 판매되지 않는 경우 소각하는 경우입니다. 이는 공정성을 유지하기 위해 사용되는 사례입니다. ICO 과정에서 팔리지 않은 토큰을 소각하지 않는 경우 발행하는 회사에서 남은 토큰을 상장 후 시장에 매각하여 부당한 이익을 취할 수 있습니다. 이러한 상황을 방지하고 공정함을 유지하기 위해, 많은 프로젝트들은 팔리지 않은 코인과 토큰을 소각하겠다는 계획을 미리 ICO 전에 고지하기도 합니다.",
                "18":"ICO 과정에서 팔리지 않은 토큰을 소각하지 않는다면 투자자들은 회사에서 남은 토큰을 시장에 매각하여 부정한 이득을 취할 수 있다고 의심할 수 있습니다.",
                "19":"따라서 이를 방지하고 공정성을 확보하기 위해 회사는 토큰을 소각하며, 이를 통해 회사에 대한 신뢰도를 제고할 수 있게 됩니다.",
                "20":"소각의 원리 및 과정",
                "21":"그렇다면 소각은 어떤 과정을 거쳐 진행되는 것일까요?",
                "22":"위에서 언급했듯이, 누구도 개인키를 알 수 없는 특정 주소를 Eater Address 라고합니다.",
                "23":"이 주소는 유효한 주소를 특정 개인키로 부터 생성하지 않고 무작위로 생성합니다.",
                "24":"이 공개된 주소 Eater Adress만으로는 절대 개인키를 알아낼 수 없기 때문에, 해당 주소로 입금된 암호화폐는 그 누구도 사용할 수 없게 됩니다.",
                "25":"실제 사용되고 있는 Eater Address 예시",
                "26":"비트코인 : 1BitcoinEaterAddressDontSendf59kuE",
                "27":"이더리움 : 0x000000000000000000000000000000000000dEaD",
                "28":"(ERC-20 기반의 WITH 토큰(WIKEN) 소각 시에도 위에 있는 이더리움 Eater Address를 사용하게 됩니다.)",
                "29":"ALLOT 코인의 소각 일정은 언제입니까?",
                "30":"ALLOT 코인의 소각 일정은 2021.03.31일로 예정되어 있습니다.",
                "31":"ALLOT 코인의 소각량은 얼마나 됩니까?",
                "32":"ALLOT재단은 ALT코인의 발행량 90%를 소각시키기로 하였습니다. 100억ALT > 10억ALT",
                "33":"ALLOT 코인의 소각 EATER ADDRESS는 어떻게 됩니까?",
                "34":"ALLOT코인은 이더리움 계열의 토큰으로 소각 주소는 0x000000000000000000000000000000000000dEaD입니다.",
            }
        }
    }
}, function () {
